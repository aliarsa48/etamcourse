            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            <a class="has-arrow" href="all-courses.html" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span> <span class="mini-click-non">Kelas</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a href="/student"><span class="mini-sub-pro">Semua Kelas</span></a></li>
                                <li><a href="/course"><span class="mini-sub-pro">Tambah Kelas Baru</span></a></li>
                            </ul>
                        </li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Kelas <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                <li><a href="/student">Semua Kelas</a>
                                                </li>
                                                <li><a href="/course">Tambah Kelas</a>
                                                </li>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="/student/payment">Pembayaran</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
