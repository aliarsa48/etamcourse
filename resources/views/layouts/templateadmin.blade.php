...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/dashboard/css/modals.css">
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li  class="active">
                            <a class="has-arrow" href="" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span> <span class="mini-click-non">Pengguna</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Students" href="/admin/teacher"><span class="mini-sub-pro">Pemateri</span></a></li>
                                <li><a title="Add Students" href="/admin/student"><span class="mini-sub-pro">Murid</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="/admin/courses"><span class="mini-sub-pro">Semua Kelas</span></a></li>
                               
                                <li><a title="Edit Professor" href="/admin/courses/active"><span class="mini-sub-pro">Kelas Aktif</span></a></li>
                                <li><a title="Professor Profile" href="/admin/courses/nonverif"><span class="mini-sub-pro">Kelas Tidak Aktif</span></a></li>
                                <li><a title="Professor Profile" href="/admin/courses/expired"><span class="mini-sub-pro">Kelas Sudah Selesai</span></a></li>
                            </ul>
                        </li>
                       
                       <li class="active">
                            <a class="has-arrow" href="" aria-expanded="false"><span class="educate-icon educate-course icon-wrap"></span> <span class="mini-click-non">Pembayaran</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="/admin/payment/request"><span class="mini-sub-pro">Pemateri</span></a></li>
                                <li><a title="Edit Professor" href="/admin/payment"><span class="mini-sub-pro">Murid</span></a></li>
                            </ul>
                        </li>
                        <li class="active">
                            <a href="" aria-expanded="false"><span class="educate-icon educate-message icon-wrap"></span> <span class="mini-click-non">Kontak Masuk</span></a>
                        </li>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                            <img src="/profile/avatar/{{Auth::user()->avatar}}" alt="" />
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Pengguna <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                <li><a href="/admin/teacher">Pemateri</a>
                                                </li>
                                                <li><a href="/admin/student">Murid</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a data-toggle="collapse" data-target="#demopro" href="#">Kelas <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demopro" class="collapse dropdown-header-top">
                                                <li><a href="/admin/courses">Semua Kelas</a>
                                                </li>
                                                <li><a href="/admin/courses/active">Kelas Aktif</a>
                                                </li>
                                                <li><a href="/admin/courses/nonverif">Kelas Tidak Aktif</a>
                                                </li>
                                                <li><a href="/admin/courses/expired">Kelas Sudah Selesai</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a data-toggle="collapse" data-target="#democrou" href="#">Pembayaran <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="democrou" class="collapse dropdown-header-top">
                                                <li><a href="/admin/payment/request">Pemateri</a>
                                                </li>
                                                <li><a href="/admin/payment">Murid</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="/admin/contact">Kontak Masuk</a>
                                        </li>
