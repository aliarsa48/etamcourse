	                                	...
	                                	<form action="/teacher/courses/{{$id->id}}/update" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-9 mg-t-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-9 mg-t-12">
                                                        <div class="file-upload-inner ts-forms">
                                                            <div class="input prepend-small-btn">
                                                                <input type="file" name="thumbnail" id="prepend-small-btn" placeholder="no file selected" class="col-9" value="{{$id->thumbnail}}" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
